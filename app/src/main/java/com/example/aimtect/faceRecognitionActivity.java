...
public class faceRecognitionActivity extends Activity implements CameraBridgeViewBase.CvCameraViewListener2{
    ...
    // call java class
    private faceRecognitionClass faceRecognitionClass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(faceRecognitionActivity.this, Manifest.permission.CAMERA)
            ...
            ActivityCompat.requestPermissions(faceRecognitionActivity.this, new String[] {Manifest.permission.CAMERA}, MY_PERMISSIONS_REQUEST_CAMERA);
        }
        ...
        try{
            ...
            faceRecognitionClass=new faceRecognitionClass(getAssets(),
                    ...
                    "face_recognition_DPR_700.tflite",
                    96);
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame){
        ...
        mRgba=faceRecognitionClass.recognizeImage(mRgba);
        //output                                         input
        //mRgba=faceRecognitionClass.recognizeImage(mRgba);
        return mRgba;
